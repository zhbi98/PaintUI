...
void ctl_tabv_refer(uint8_t * vm)
{
    ...
    if (lv_tab_get_page_id() == 0) {
        ...
        display_N2string(LIST_LINE2_Y + 1, _Area[_area_idx].set_x + 18, ALIGN_SPECIFY, LAYOUT_R11,  0, list_content[LIST_AUTO_SHTDWN], _MENU_LAST, itemcolor[2], INV_OFF, vm);
        display_N2string(LIST_LINE3_Y + 1, _Area[_area_idx].set_x + 18, ALIGN_SPECIFY, LAYOUT_R11,  0, list_content[LIST_COMPARE_MAX], _MENU_LAST, itemcolor[3], INV_OFF, vm);
        display_N2string(LIST_LINE4_Y + 1, _Area[_area_idx].set_x + 18, ALIGN_SPECIFY, LAYOUT_R11,  0, list_content[LIST_COMPARE_MIN], _MENU_LAST, itemcolor[4], INV_OFF, vm);
        display_N2string(LIST_LINE5_Y + 1, _Area[_area_idx].set_x + 18, ALIGN_SPECIFY, LAYOUT_R11,  0, list_content[LIST_COMPARE_TYPE],_MENU_LAST, itemcolor[5], INV_OFF, vm);
        display_N2string(LIST_LINE6_Y + 1, _Area[_area_idx].set_x + 18, ALIGN_SPECIFY, LAYOUT_R11,  0, list_content[LIST_RECORD_RATE], _MENU_LAST, itemcolor[6], INV_OFF, vm);
        display_N2string(LIST_LINE7_Y + 1, _Area[_area_idx].set_x + 18, ALIGN_SPECIFY, LAYOUT_R11,  0, list_content[LIST_MEMORY_MODE], _MENU_LAST, itemcolor[7], INV_OFF, vm);

        if (lv_tab_get_opti_id() == 0) {
            memset(inverse, INV_OFF, 3);
            inverse[lv_tab_get_hidx()] = INV_ON;
        } else memset(inverse, INV_OFF, 3);
    ...
    if (lv_tab_get_page_id() == 1) {
        ...
        display_N2string(LIST_LINE2_Y + 1, _Area[_area_idx].set_x + 18, ALIGN_SPECIFY, LAYOUT_R11, 0,  list_content[LIST_SOUND],          _MENU_LAST, itemcolor[2], INV_OFF, vm);
        display_N2string(LIST_LINE3_Y + 1, _Area[_area_idx].set_x + 18, ALIGN_SPECIFY, LAYOUT_R11, 0,  list_content[LIST_COLOR],          _MENU_LAST, itemcolor[3], INV_OFF, vm);
