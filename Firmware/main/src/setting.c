...
void setting_level1_menu(uint8_t key_event, uint8_t * vm)
{
    switch (key_event) {
    case F1_KEY_EVT:
...
void setting_level1_key_event(uint8_t key_event)
{
    switch (key_event) {
    case F1_KEY_EVT:
        lv_time_set_val(-1);
...
void setting_level1_key_event_enable(uint8_t key_event)
{
